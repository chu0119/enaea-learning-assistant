...
- **Greasy Fork**: https://greasyfork.org/zh-CN/scripts/586431-enaea-learning-assistant
...
| 版本 | 说明 | 适合人群 |
|------|------|----------|
| **基础版** (`enaea-auto-player.js`) | 无 GUI 面板，功能完整 | 喜欢简洁、不影响页面的用户 |
| **GUI版** (`enaea-gui.js`) | 带图形化控制面板 | 需要可视化操作的用户 |
...
1. 访问 [Greasy Fork](https://greasyfork.org/zh-CN/scripts/586431-enaea-learning-assistant)
2. 点击 "安装此脚本"
3. 确认安装即可
...
2. 选择版本：
   - 基础版：点击 `enaea-auto-player.js` 文件
   - GUI版：点击 `enaea-gui.js` 文件
3. 点击 "Raw" 按钮查看原始代码
4. 复制全部代码
